...
export class CategoryService {
  constructor(private apollo: Apollo) { }// injector service
  ...
  getCategories(): Observable<any> {
    ...
    `;
    return this.apollo.watchQuery({ query: GET_CATEGORIES }).valueChanges;// apollo is send GraphQL queries and mutations to the server.
  }
